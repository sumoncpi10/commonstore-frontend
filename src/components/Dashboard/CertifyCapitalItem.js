...
const CertifyCapitalItem = ({ capitalItem, itemType, categroys, subcategroys, brands, models, suppliers }) => {
    ...
    const onFinish = (values) => {
        ...
        const approveByMobleNo = session?.mobileNo?.mobileNo;
        const withvalues = { approveByMobleNo };
